...
- `FB_Selector` automatic positioning/homing core implemented with bounded calibration, command replay protection, wrap-safe timeouts, limit checks, and mutually exclusive logical outputs.
